...
T = TypeVar("T", bound="PullRequestActionRequest")



@_attrs_define
class PullRequestActionRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pull_request_action_request = cls(
            forge=forge,
            full_name=full_name,
            number=number,
        )
        ...
        pull_request_action_request.additional_properties = d
        return pull_request_action_request
